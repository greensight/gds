...
const FormAutokit: React.FC<IForm> = ({}) => {
    const theme = useTheme();
    const formTheme = theme.components?.Form || baseTheme.components.Form;
    const Icon = Icon || theme.global?.placeholder || baseTheme.global?.placeholder;
    const SuccessIcon = theme.global?.success;
    const ErrorIcon = theme.global?.error;
    return (
