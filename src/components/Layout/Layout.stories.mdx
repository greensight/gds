...
<Meta title="Dev | Components / Layout / Layout" component={Layout} />
...
<Preview>
    <Story name="Media Queries">
        <Layout gap={{_: major(4), lg: major(3), sm: major(2), xs: major(1)}}>
            {[1, 2, 3, 4, 5, 6].map(item => (
...
<Preview>
    <Story name="Alignment">
        <Layout cols={3} justify="end" align="center" css={{height: major(30)}}>
            {[1, 2, 3, 4, 5, 6].map(item => (
                <Layout.Item key={item}>
                    <Item>Item {item}</Item>
                </Layout.Item>
