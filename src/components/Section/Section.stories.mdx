...
💬 В документации используется компонент `Item` чисто в демонстративных целях – визуально показать бокс контента. Это вспомогательный компонент GDS и на проекте его не будет.
