...
Указание обязательности заполнения поля, к которому относится легенда. Это может быть текст, указывающий на необязательность заполнения поля, или астериск. Паттерн отображения обязательности определяеься на уровне Form, поэтому проп `optional` имеет смысл внутри Form.
    ...
    <Story name="Optional">
        {() => {
            ...
            return (
                ...
                >
                    <Form.Field controlId="optionalInput1">
                        <Legend as="legend" optional="(optional)">
                            Legend 1
                        </Legend>
                    </Form.Field>
                    <Form.Field controlId="optionalInput2">
                        <Legend as="legend">Legend 2</Legend>
                    </Form.Field>
                </Form>
            );
        }}
        ...
        {() => {
            ...
            return (
                <Form
                    ...
                    requiredRule="mark"
                >
                    <Form.Field controlId="markInput1">
                        <Legend as="legend" optional={true}>
                            Legend 1
                        </Legend>
                    </Form.Field>
                    <Form.Field controlId="markInput2">
                        <Legend as="legend">Legend 2</Legend>
                    </Form.Field>
                </Form>
            );
            ...
            return (
                ...
                >
                    <Form.Field
                        ...
                        hintPosition={
                            boolean('Hint', true, 'Field')
                                ? radios('hintPosition', ['top', 'bottom'], 'top', 'Field')
                                : undefined
                        }
                    ...
                    >
                        <Legend
                            ...
                            hiddenLegend={boolean('Hidden Label', false, 'Legend')}
                            ...
                            __theme={
                                boolean('Use custom theme', false, 'Legend')
                                    ? object('themeObj', baseTheme.components.Legend, 'Legend')
                                    : undefined
                            }
                        >
                            Лейбл
