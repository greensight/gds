...
Опциональный текст, указывающий на необязательность поля, к которому относится легенда. Имеет смысл только при использовании внутри Form
    ...
    <Story name="Optional">
        {() => {
            ...
            return (
                ...
                >
                    <Form.Field controlId="exampleInput">
