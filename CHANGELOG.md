...
-   Move to new jsx transform. So you don't need to `import React from 'react'`. (more about jsx transform)[https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html]
